...
<a href="{{ route('admin') }}" class="logo-small">
...
<ul>
<li>
<a href="{{ route('admin') }}"><img src="assets/img/icons/dashboard.svg" alt="img"><span> Dashboard</span> </a>
</li>
<li class="submenu">
...
<li><a href="{{ route('userlist') }}" class="active">Users List</a></li>
</ul>
</li>
<li class="submenu">
...
<td>
    <!-- Edit Button -->
    <a class="me-3" href="edit">
        <img src="assets/img/icons/edit.svg" alt="Edit">
    </a>&nbsp;&nbsp;&nbsp;

    <!-- Delete Button (Only if usertype is 0) -->
    @if($data->usertype == "0")
        <a class="me-3 confirm-text" href="{{ route('users.destroy', $data->id) }}" onclick="return confirm('Are you sure you want to delete this user?');">
